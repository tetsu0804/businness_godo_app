...
RSpec.feature '月別仕事一覧', type: :feature do
  before do
    ...
    @job_by_month = JobContent.create(title: 'ヨークベニマル米沢店', description: 'ヨークベニマル本社からの販促物', start_time: 'Mon, 22 Jun 2020 10:00:00 JST +09:00', price: 1000, work_address: '山形県米沢市駅前町3-3-3333', user_id: @eriko.id, department_id: @tankyori.id, trading_company_id: @benimalyonezawa.id)
